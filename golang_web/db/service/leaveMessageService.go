...
// 获取留言页展示的留言
func (l *LeaveMessageService) GetDisplayMessage(pageNum, pageSize int) ([]model.Message, int, int) {
...
func (l *LeaveMessageService) GetPageMessage(pageNum, pageSize int) ([]model.Message, int) {
	pageStart := (pageNum - 1) * pageSize
